app.run(function($futureState, indexFactory, filtersFactory) {
    ...
    var state = indexFactory.buildState('reputation', 'asc', 'loadOrderNotes', filterPrototypes);
    $futureState.futureState(state);
});

app.controller('loadOrderNotesController', function ($scope, $stateParams, $state, currentUser, contributionService, indexService,  filtersFactory, indexFactory) {
