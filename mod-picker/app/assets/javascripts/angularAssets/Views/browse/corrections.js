app.run(function($futureState, indexFactory, filtersFactory) {
    ...
    var state = indexFactory.buildState('id', 'asc', 'corrections', filterPrototypes);
    $futureState.futureState(state);
});

app.controller('correctionsController', function ($scope, $stateParams, $state, currentUser, contributionService, indexService,  filtersFactory, indexFactory) {
