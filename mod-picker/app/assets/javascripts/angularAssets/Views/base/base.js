...
app.controller('baseController', function($scope, $rootScope, $state, $window, currentUser, activeModList, games, currentGame, categories, categoryPriorities, userService, modListService) {
