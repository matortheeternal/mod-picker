...
app.controller('modlistController', function($scope) {
	...
	useTwoColumns(false);
	/*vars*/
	$scope.modlistTitle = "ThreeTen's Complete Weather & AI Overhaul - With ENB";
