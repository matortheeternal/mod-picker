class ReviewsController < ContributionsController
  ...
  private
    ...
    def filtering_params
      params[:filters].slice(:include_adult, :hidden, :approved, :game, :search, :submitter, :editor, :overall_rating, :helpfulness, :reputation, :helpful_count, :not_helpful_count, :ratings_count, :submitted, :edited);
    end
