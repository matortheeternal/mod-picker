class HomeController < ApplicationController
  ...
  def skyrim
    ...
    if current_user.present?
      @current_theme = current_user.settings.skyrim_theme || 'High Hrothgar'
    else
  ...
  def skyrimse
    ...
    if current_user.present?
      @current_theme = current_user.settings.skyrimse_theme || 'Falkreath'
    else
  ...
  def fallout4
    ...
    if current_user.present?
      @current_theme = current_user.settings.fallout4_theme || 'Workshop'
    else
