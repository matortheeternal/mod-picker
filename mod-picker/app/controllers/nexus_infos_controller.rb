class NexusInfosController < ApplicationController
  ...
  private
    ...
    def nexus_info_params
      params.require(:nexus_info).permit(:nm_id, :uploaded_by, :authors, :datetime_released, :datetime_updated, :endorsements, :total_downloads, :unique_downloads, :views, :posts_count, :videos_count, :images_count, :files_count, :articles_count, :nexus_category, :changelog)
    end
end
