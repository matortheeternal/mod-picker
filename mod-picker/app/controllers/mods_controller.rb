  ...
  private
    ...
    def mod_params
      params.require(:mod).permit(:game_id, :name, :authors, :aliases, :is_utility, :has_adult_content, :primary_category_id, :secondary_category_id, :released, :updated, :nexus_info_id, :lover_info_id, :workshop_info_id, :curate,
         ...
         tag_names: [],
         mod_options_attributes: [:name, :display_name, :size, :md5_hash, :default, :is_fomod_option,
            asset_paths: [],
    ...
    def mod_update_params
      p = params.require(:mod).permit(:name, :authors, :aliases, :is_utility, :has_adult_content, :status, :primary_category_id, :secondary_category_id, :released, :updated, :mark_updated, :nexus_info_id, :lover_info_id, :workshop_info_id, :disallow_contributors, :disable_reviews, :lock_tags, :hidden, :approved,
         ...
         tag_names: [],
         mod_options_attributes: [:id, :name, :display_name, :size, :md5_hash, :default, :is_fomod_option, :_destroy,
            asset_paths: [],
