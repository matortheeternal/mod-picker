class CorrectionsController < ApplicationController
  ...
  private
    ...
    def filtering_params
      params[:filters].slice(:include_adult, :game, :search, :submitter, :editor, :status, :mod_status, :correctable, :reputation, :agree_count, :disagree_count, :comments, :submitted, :edited);
    end
