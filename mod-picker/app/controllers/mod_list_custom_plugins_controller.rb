class ModListCustomPluginsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mod_list_custom_plugin.save
        format.html { redirect_to @mod_list_custom_plugin, notice: 'Mod list custom plugin was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @mod_list_custom_plugin.update(mod_list_custom_plugin_params)
        format.html { redirect_to @mod_list_custom_plugin, notice: 'Mod list custom plugin was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to mod_list_custom_plugins_url, notice: 'Mod list custom plugin was successfully destroyed.' }
  ...
  private
    ...
    def mod_list_custom_plugin_params
      params.require(:mod_list_custom_plugin).permit(:ml_id, :active, :load_order, :title, :description)
    end
end
