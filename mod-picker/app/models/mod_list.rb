class ModList < ActiveRecord::Base
  ...
  def modlist_text
    base = "# This file was automatically generated by Mod Picker\r\n"
    mods = mod_list_mods.utility(false).official(false).includes(:mod).order(:index => :DESC)
    mods.reduce(base) { |text, mod_list_mod| "#{text}+#{mod_list_mod.mod.name}\r\n" }
  end

  def plugins_text
    base = "# This file was automatically generated by Mod Picker\r\n"
    plugins = mod_list_plugins.includes(:plugin).order(:index)
    plugins.reduce(base) { |text, mod_list_plugin| "#{text}#{mod_list_plugin.plugin.filename}\r\n"}
  end
