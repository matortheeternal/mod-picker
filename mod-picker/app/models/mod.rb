class Mod < ActiveRecord::Base
  ...
  has_many :users_who_starred, :class_name => 'User', :through => 'user_mod_star_maps', :inverse_of => 'starred_mods'
  has_many :authors, :class_name => 'User', :through => 'user_mod_author_maps', :inverse_of => 'mods'
