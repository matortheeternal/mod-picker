...
class UserReputationsControllerTest < ActionController::TestCase
  ...
  test "should create user_reputation" do
    assert_difference('UserReputation.count') do
      post :create, user_reputation: { audiovisual_design: @user_reputation.audiovisual_design, id: @user_reputation.id, offset: @user_reputation.offset, overall: @user_reputation.overall, plugin_design: @user_reputation.plugin_design, script_design: @user_reputation.script_design, user_id: @user_reputation.user_id, utility_design: @user_reputation.utility_design }
    end
