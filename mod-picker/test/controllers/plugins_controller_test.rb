...
class PluginsControllerTest < ActionController::TestCase
  ...
  test "should create plugin" do
    assert_difference('Plugin.count') do
      post :create, plugin: { author: @plugin.author, description: @plugin.description, filename: @plugin.filename, hash: @plugin.hash, mv_id: @plugin.mv_id, pl_id: @plugin.pl_id }
    end
  ...
  test "should update plugin" do
    patch :update, id: @plugin, plugin: { author: @plugin.author, description: @plugin.description, filename: @plugin.filename, hash: @plugin.hash, mv_id: @plugin.mv_id, pl_id: @plugin.pl_id }
    assert_redirected_to plugin_path(assigns(:plugin))
  end
