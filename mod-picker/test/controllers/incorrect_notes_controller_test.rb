...
class IncorrectNotesControllerTest < ActionController::TestCase
  ...
  test "should create incorrect_note" do
    assert_difference('IncorrectNote.count') do
      post :create, incorrect_note: { cn_id: @incorrect_note.cn_id, id: @incorrect_note.id, in_id: @incorrect_note.in_id, r_id: @incorrect_note.r_id, reason: @incorrect_note.reason, submitted_by: @incorrect_note.submitted_by }
    end
  ...
  test "should update incorrect_note" do
    patch :update, id: @incorrect_note, incorrect_note: { cn_id: @incorrect_note.cn_id, id: @incorrect_note.id, in_id: @incorrect_note.in_id, r_id: @incorrect_note.r_id, reason: @incorrect_note.reason, submitted_by: @incorrect_note.submitted_by }
    assert_redirected_to incorrect_note_path(assigns(:incorrect_note))
  end
